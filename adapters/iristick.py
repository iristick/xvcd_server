...
class Iristick(PyFTDIAdapter):
    ...
    def __init__(self, debug=False):
        ...
        ftdi.Ftdi.add_custom_product(0x0403, 0x6016)
        self._jtag = JtagController(trst=0x10, frequency=self.MAX_FREQ, debug=debug, usb_read_timeout=10000, usb_write_timeout=10000)
